...
\
  ...
  connect_bd_intf_net -intf_net u0_zynq_ps_M_AXI_HPM0_FPD [get_bd_intf_pins axi_vip_0/S_AXI] [get_bd_intf_pins u0_zynq_ps/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net u0_zynq_ps_pl_clk0 [get_bd_pins u0_zynq_ps/pl_clk0] [get_bd_pins u0_zynq_ps/maxihpm0_fpd_aclk] [get_bd_pins u4_zynq_ps_rst/slowest_sync_clk] [get_bd_ports clk_100mhz] [get_bd_pins axi_vip_0/aclk]
  connect_bd_net -net u0_zynq_ps_pl_resetn0 [get_bd_pins u0_zynq_ps/pl_resetn0] [get_bd_pins u4_zynq_ps_rst/ext_reset_in]
  connect_bd_net -net u4_zynq_ps_rst_peripheral_aresetn [get_bd_pins u4_zynq_ps_rst/peripheral_aresetn] [get_bd_pins axi_vip_0/aresetn]
  connect_bd_net -net u4_zynq_ps_rst_peripheral_reset [get_bd_pins u4_zynq_ps_rst/peripheral_reset] [get_bd_ports rst]

  # Create address segments
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces u0_zynq_ps/Data] [get_bd_addr_segs axi_vip_0/S_AXI/Reg] -force
